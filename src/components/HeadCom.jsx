    ...
    <header className="Navigation">
        ...
        <div className="navMenu">
            <ul type="none" className={isOpen ? "navItem active" : "navItem"} >
                ...
                <li><Link to="/product_type" className="navLink">Kitchen appliances</Link></li>
                <li><Link to="/product_type" className="navLink">Audio & Video</Link></li>
                <li><Link to="/product_type" className="navLink">Labtop</Link></li>
                <li><Link to="/product_type" className="navLink">Smart watchs</Link></li>
